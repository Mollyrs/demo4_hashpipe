...
#define FFTPLAN1_ISTRIDE     16
#define FFTPLAN1_OSTRIDE     1
#define FFTPLAN1_IDIST       NFFT*FFTPLAN1_ISTRIDE
#define FFTPLAN1_ODIST       NFFT/2 + 1 
...
#define FFTPLAN3_ISTRIDE     4
#define FFTPLAN3_OSTRIDE     1
#define FFTPLAN3_IDIST       NFFT*FFTPLAN3_ISTRIDE
#define FFTPLAN3_ODIST       NFFT/2 + 1 
...
#define FFTPLAN4_ISTRIDE     2
#define FFTPLAN4_OSTRIDE     1
#define FFTPLAN4_IDIST       NFFT*FFTPLAN4_ISTRIDE
#define FFTPLAN4_ODIST       NFFT/2 + 1 
...
#define FFTPLAN5_IDIST       NFFT*FFTPLAN5_ISTRIDE
#define FFTPLAN5_ODIST       NFFT/2 + 1 
